...
Modx = {
    ...
    language_servers = {"bashls", "ccls", "cmake", "cssls", "diagnosticls", "dockerls", "efm", "eslint", "emmet_ls",
                        "gopls", "html", "jsonls", "tsserver", "sumneko_lua", "intelephense", "pyright", "sqlls",
                        "stylelint_lsp", "svelte", "tailwindcss", "vuels", "lemminx", "yamlls", "rust_analyzer"},
        ...
        toggleterm = {
            ...
            which_key = {
                ...
                definitions = {
                    ...
                    l = {"<cmd>lua Modx.plugins.toggleterm.toggle_lazygit()<cr>", "LazyGit"}
                }
            }
        },
        treesitter = {
